...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100">
      ...
      <Link to="/signup" className="bg-blue-500 text-white px-6 py-3 rounded shadow-lg hover:bg-blue-600 mr-4">
        Sign Up
      </Link>
      <Link to="/signin" className="bg-green-500 text-white px-6 py-3 rounded shadow-lg hover:bg-green-600">
        Sign In
      </Link>
    </div>
  );
